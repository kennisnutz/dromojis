...
## CollectionMetaData
TLB: `_ image:^string name:^string description:^string social_links:^cell = CollectionMetaData`
Signature: `CollectionMetaData{image:^string,name:^string,description:^string,social_links:^cell}`
...
## CollectionData
TLB: `collection_data#6a893098 next_item_index:int257 collection_content:^cell owner_address:address = CollectionData`
...
## MintParams
TLB: `mint_params#4d696e74 query_id:uint32 amount:int257 = MintParams`
Signature: `MintParams{query_id:uint32,amount:int257}`

## WithdrawParams
TLB: `withdraw_params#57697468 query_id:int257 amount:int257 destination:address = WithdrawParams`
Signature: `WithdrawParams{query_id:int257,amount:int257,destination:address}`
...
46604: Ton Owls:In sufficient funds sent
49280: not owner
49640: Minted out!!
