...
function dictValueParserWithdrawParams(): DictionaryValue<WithdrawParams> {
 ...
 type DropmojisCollection_init_args = {
    $$type: 'DropmojisCollection_init_args';
    collection_content: Cell;
...
function initDropmojisCollection_init_args(src: DropmojisCollection_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeRef(src.collection_content);
        b_0.store(storeRoyaltyParams(src.royalty_params));
        let b_1 = new Builder();
        b_1.storeInt(src.totalSupply, 257);
        b_0.storeRef(b_1.endCell());
    };
}

async function DropmojisCollection_init(collection_content: Cell, royalty_params: RoyaltyParams, totalSupply: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initDropmojisCollection_init_args({ $$type: 'DropmojisCollection_init_args', collection_content, royalty_params, totalSupply })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const DropmojisCollection_errors: { [key: number]: { message: string } } = {
...
const DropmojisCollection_types: ABIType[] = [
...
const DropmojisCollection_getters: ABIGetter[] = [
...
const DropmojisCollection_receivers: ABIReceiver[] = [
...
export class DropmojisCollection implements Contract {
    
    static async init(collection_content: Cell, royalty_params: RoyaltyParams, totalSupply: bigint) {
        return await DropmojisCollection_init(collection_content, royalty_params, totalSupply);
    }
    
    static async fromInit(collection_content: Cell, royalty_params: RoyaltyParams, totalSupply: bigint) {
        const init = await DropmojisCollection_init(collection_content, royalty_params, totalSupply);
        const address = contractAddress(0, init);
        return new DropmojisCollection(address, init);
    }
    
    static fromAddress(address: Address) {
        return new DropmojisCollection(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  DropmojisCollection_types,
        getters: DropmojisCollection_getters,
        receivers: DropmojisCollection_receivers,
        errors: DropmojisCollection_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'Mint' | MintParams | 'Withdraw' | GetRoyaltyParams | Deploy) {
